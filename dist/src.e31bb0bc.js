...
class Auth {
  ...
  async signIn(userData) {
    ...
    if (data.user.newUser == true) {
      //new user! redirect new users to the guide page (/guide)
...
class UserAPI {
  ...
  async addFavUser(userId) {
    // validate
    if (!userId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavUser"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding user to favourites');
    } // convert response payload into json - store as data
...
class HomeView {
  ...
  async getUsers() {
    try {
      this.users = await _UserAPI.default.getAllUsers();
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.users == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.users.map(user => JSON.stringify(_Auth.default.currentUser).includes(user._id) ? '' : (0, _litHtml.html)(_templateObject4(), user._id, user._id, user.firstName, user.lastName, user.avatar, user.bio, user.sports, user.availableDays))));
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../UserAPI":"UserAPI.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n    <style>\n        .profile-wrap {\n          margin-top: 4em;\n        }\n    </style>\n      <va-app-header title=\"Profile\" user=\"", "\"></va-app-header>\n\n      <div class=\"profile-wrap\">\n\n        <va-user2 class=\"user-card ", "\"\n          id=\"", "\"\n          firstName=\"", "\"\n          lastName=\"", "\"\n          avatar=\"", "\"\n          bio=\"", "\"\n          sports=\"", "\"\n          availableDays=\"", "\"\n        >\n        </va-user2>\n\n      </div>\n\n      <sl-button class=\"edit-class-btn\" circle size=\"small\" @click=", "><sl-icon name=\"gear-fill\"></sl-icon></sl-button>\n    "]);
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n            <sl-avatar id=\"edit-prof-av\" style=\"--size: 200px; margin-bottom: 1em;\" image=", "></sl-avatar>\n              <label for=\"file-upload\" class=\"custom-file-upload\">\n              <sl-icon name=\"pencil-fill\"></sl-icon>\n              </label>\n                <input id=\"file-upload\" type=\"file\" name=\"avatar\" />\n            "]);
...
function _templateObject3() {
  const data = _taggedTemplateLiteral(["\n\n          <sl-form class=\"page-form\" @sl-submit=", ">\n\n          <div class=\"input-group a\">         \n            ", "\n          </div>\n\n          <h2>", "</h2>\n          <p id=\"rank-text\" >Intermediate | Rank: 527</p>\n          <h4 id=\"location-tag\">Canning Vale, WA</h4>\n\n            <div class=\"input-group\">\n              <sl-input class=\"input-bar2\" pill type=\"text\" name=\"firstName\" value=\"", "\" placeholder=\"First Name\"></sl-input>\n            </div>\n            <div class=\"input-group\">\n              <sl-input class=\"input-bar2\" pill type=\"text\" name=\"lastName\" value=\"", "\" placeholder=\"Last Name\"></sl-input>\n            </div>\n            <div class=\"input-group\">\n              <sl-input class=\"input-bar2\" pill type=\"text\" name=\"email\" value=\"", "\" placeholder=\"Email Address\"></sl-input>\n            </div>\n            \n            <div class=\"input-group\">\n              <sl-textarea class=\"input-bar2 b\" name=\"bio\" rows=\"4\" placeholder=\"Bio\" value=\"", "\"></sl-textarea>\n            </div>\n            <sl-button type=\"primary\" pill class=\"submit-btn2\" submit>Update Profile</sl-button>\n          </sl-form>\n        "]);
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.updateProfileSubmitHandler.bind(this), this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _Auth.default.currentUser && _Auth.default.currentUser.avatar ? "".concat(_App.default.apiBase, "/images/").concat(_Auth.default.currentUser.avatar) : '') : (0, _litHtml.html)(_templateObject5()), _Auth.default.currentUser.firstName, this.user.firstName, this.user.lastName, this.user.email, this.user.bio));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class GuideView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.updateProfileSubmitHandler.bind(this), this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _Auth.default.currentUser && _Auth.default.currentUser.avatar ? "".concat(_App.default.apiBase, "/images/").concat(_Auth.default.currentUser.avatar) : '') : (0, _litHtml.html)(_templateObject5())), () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/favouriteUsers.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n        .page-content {\n          padding: 1em;\n          overflow: auto;\n        }\n      </style>\n\n      <va-app-header title=\"Your Competitors\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <div class=\"users-grid\">\n        ", "\n        </div>\n        \n      </div>      \n    "]);
...
class FavouriteUsersView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.favUsers == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.favUsers.map(user => (0, _litHtml.html)(_templateObject4(), user._id, user._id, user.firstName, user.lastName, user.avatar, user.bio, user.sports, user.availableDays))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/messages.js":[function(require,module,exports) {
"use strict";
...
class MessagesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.favUsers == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.favUsers.map(user => (0, _litHtml.html)(_templateObject4(), user._id, user._id, user.firstName, user.lastName, user.avatar, user.bio, user.sports, user.availableDays))), this.favUsers == null ? (0, _litHtml.html)(_templateObject5()) : (0, _litHtml.html)(_templateObject6(), this.favUsers.map(user => (0, _litHtml.html)(_templateObject7(), user._id, user._id, user.firstName, user.lastName, user.avatar, user.bio, user.sports, user.availableDays))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"../node_modules/boxicons/dist/boxicons.js":[function(require,module,exports) {
var define;
...
},{}],"views/pages/categories.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","boxicons":"../node_modules/boxicons/dist/boxicons.js"}],"views/pages/settings.js":[function(require,module,exports) {
"use strict";
...
class SettingsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), () => _Auth.default.signOut());
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/tennis.js":[function(require,module,exports) {
"use strict";
...
function _templateObject9() {
  const data = _taggedTemplateLiteral(["<h4 class=\"text-center\"><style>h4{margin: auto;}</style>You haven't liked any ", " playing users!</h4>"]);
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n        .page-content {\n          padding: 1em;\n          overflow-x: hidden;\n        }\n\n        h3 {\n          color: var(--brand-color);\n        }\n\n        .text-center {\n          text-align: center;\n        }\n      </style>\n\n      <va-app-header title=\"Tennis\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-content\">\n\n        <h3>New Competitors</h3>     \n        <div class=\"avatar-div\">\n        ", " \n        </div>\n        <br>\n        <h3>Messages</h3>  \n          ", " \n      </div>   \n    "]);
...
class TennisView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.favUsers == null ? (0, _litHtml.html)(_templateObject2()) : JSON.stringify(this.favUsers).includes(this.sport) ? (0, _litHtml.html)(_templateObject3(), this.favUsers.map(user => JSON.stringify(user).includes(this.sport) ? (0, _litHtml.html)(_templateObject4(), user._id, user._id, user.firstName, user.lastName, user.avatar, user.bio, user.sports, user.availableDays) : '')) : (0, _litHtml.html)(_templateObject5(), this.sport), this.favUsers == null ? (0, _litHtml.html)(_templateObject6()) : JSON.stringify(this.favUsers).includes(this.sport) ? (0, _litHtml.html)(_templateObject7(), this.favUsers.map(user => JSON.stringify(user).includes(this.sport) ? (0, _litHtml.html)(_templateObject8(), user._id, user._id, user.firstName, user.lastName, user.avatar, user.bio, user.sports, user.availableDays) : '')) : (0, _litHtml.html)(_templateObject9(), this.sport));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new TennisView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/boxing.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n        .page-content {\n          padding: 1em;\n          overflow-x: hidden;\n        }\n\n        h3 {\n          color: var(--brand-color);\n        }\n      </style>\n\n      <va-app-header title=\"Boxing\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-content\">\n\n<h3>New Competitors</h3>     \n<div class=\"avatar-div\">\n", " \n</div>\n<br>\n<h3>Messages</h3>  \n  ", " \n</div>   \n    "]);
...
var _default = new BoxingView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/basketball.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n        .page-content {\n          padding: 1em;\n          overflow-x: hidden;\n        }\n\n        h3 {\n          color: var(--brand-color);\n        }\n      </style>\n\n      <va-app-header title=\"Basketball\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-content\">\n\n      <h3>New Competitors</h3>     \n      <div class=\"avatar-div\">\n      ", " \n      </div>\n      <br>\n      <h3>Messages</h3>  \n        ", " \n      </div>   \n    "]);
...
var _default = new BasketballView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/tableTennis.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n        .page-content {\n          padding: 1em;\n          overflow-x: hidden;\n        }\n\n        h3 {\n          color: var(--brand-color);\n        }\n      </style>\n\n      <va-app-header title=\"Table Tennis\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-content\">\n\n<h3>New Competitors</h3>     \n<div class=\"avatar-div\">\n", " \n</div>\n<br>\n<h3>Messages</h3>  \n  ", " \n</div>    \n    "]);
...
class TableTennisView {
  init() {
    document.title = 'Table Tennis';
    this.favUsers = null;
    this.filteredUsers = null;
    this.sport = 'tableTennis';
    this.render();
...
var _default = new TableTennisView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/martialArts.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n        .page-content {\n          padding: 1em;\n          overflow-x: hidden;\n        }\n\n        h3 {\n          color: var(--brand-color);\n        }\n      </style>\n\n      <va-app-header title=\"Martial Arts\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-content\">\n\n<h3>New Competitors</h3>     \n<div class=\"avatar-div\">\n", " \n</div>\n<br>\n<h3>Messages</h3>  \n  ", " \n</div>   \n    "]);
...
var _default = new MartialArtsView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/chess.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n        .page-content {\n          padding: 1em;\n          overflow-x: hidden;\n        }\n\n        h3 {\n          color: var(--brand-color);\n        }\n      </style>\n\n      <va-app-header title=\"Chess\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-content\">\n\n<h3>New Competitors</h3>     \n<div class=\"avatar-div\">\n", " \n</div>\n<br>\n<h3>Messages</h3>  \n  ", " \n</div>    \n    "]);
...
var _settings = _interopRequireDefault(require("./views/pages/settings"));

var _tennis = _interopRequireDefault(require("./views/pages/tennis"));

var _boxing = _interopRequireDefault(require("./views/pages/boxing"));

var _basketball = _interopRequireDefault(require("./views/pages/basketball"));

var _tableTennis = _interopRequireDefault(require("./views/pages/tableTennis"));

var _martialArts = _interopRequireDefault(require("./views/pages/martialArts"));

var _chess = _interopRequireDefault(require("./views/pages/chess"));
...
const routes = {
  ...
  '/tennis': _tennis.default,
  '/boxing': _boxing.default,
  '/basketball': _basketball.default,
  '/tableTennis': _tableTennis.default,
  '/martialArts': _martialArts.default,
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/favouriteUsers":"views/pages/favouriteUsers.js","./views/pages/messages":"views/pages/messages.js","./views/pages/categories":"views/pages/categories.js","./views/pages/settings":"views/pages/settings.js","./views/pages/tennis":"views/pages/tennis.js","./views/pages/boxing":"views/pages/boxing.js","./views/pages/basketball":"views/pages/basketball.js","./views/pages/tableTennis":"views/pages/tableTennis.js","./views/pages/martialArts":"views/pages/martialArts.js","./views/pages/chess":"views/pages/chess.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title) : "", _Router.anchorRoute, e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', this.user && this.user.firstName, () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => (0, _Router.gotoRoute)('/settings'), () => _Auth.default.signOut(), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, () => _Auth.default.signOut());
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"components/va-user.js":[function(require,module,exports) {
"use strict";
...
function _templateObject14() {
  const data = _taggedTemplateLiteral(["<style> .wk-day.sunday p{color: #00f50c}</style>"]);
...
function _templateObject13() {
  const data = _taggedTemplateLiteral(["<style> .wk-day.saturday p{color: #00f50c}</style>"]);
...
function _templateObject12() {
  const data = _taggedTemplateLiteral(["<style> .wk-day.friday p{color: #00f50c}</style>"]);
...
function _templateObject11() {
  const data = _taggedTemplateLiteral(["<style> .wk-day.thursday p{color: #00f50c}</style>"]);
...
function _templateObject10() {
  const data = _taggedTemplateLiteral(["<style> .wk-day.wednesday p{color: #00f50c}</style>"]);
...
function _templateObject9() {
  const data = _taggedTemplateLiteral(["<style> .wk-day.tuesday p{color: #00f50c}</style>"]);
...
function _templateObject8() {
  const data = _taggedTemplateLiteral(["<style> .wk-day.monday p{color: #00f50c}</style>"]);
...
function _templateObject7() {
  const data = _taggedTemplateLiteral(["<style> .chess{display: none}</style>"]);
...
function _templateObject6() {
  const data = _taggedTemplateLiteral(["<style> .martialArts{display: none}</style>"]);
...
function _templateObject5() {
  const data = _taggedTemplateLiteral(["<style> .tableTennis{display: none}</style>"]);
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["<style> .basketball{display: none}</style>"]);
...
function _templateObject3() {
  const data = _taggedTemplateLiteral(["<style> .boxing{display: none}</style>"]);
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["<style> .tennis{display: none}</style>"]);
...
customElements.define('va-user', class User extends _litElement.LitElement {
  ...
  async addFavHandler() {
    ...
    try {
      await _UserAPI.default.addFavUser(this.id);

      _Toast.default.show('Competitor Saved');
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.addFavHandler.bind(this), this.declineUser.bind(this), () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/'), () => (0, _Router.gotoRoute)('/messages'), _App.default.apiBase, this.avatar, this.firstName, this.sports.includes('tennis') ? 'Tennis' : (0, _litElement.html)(_templateObject2()), this.sports.includes('boxing') ? 'Boxing' : (0, _litElement.html)(_templateObject3()), this.sports.includes('basketball') ? 'Basketball' : (0, _litElement.html)(_templateObject4()), this.sports.includes('tableTennis') ? 'Table Tennis' : (0, _litElement.html)(_templateObject5()), this.sports.includes('martialArts') ? 'Martial Arts' : (0, _litElement.html)(_templateObject6()), this.sports.includes('chess') ? 'Chess' : (0, _litElement.html)(_templateObject7()), this.bio, this.availableDays.includes('monday') ? (0, _litElement.html)(_templateObject8()) : null, this.availableDays.includes('tuesday') ? (0, _litElement.html)(_templateObject9()) : null, this.availableDays.includes('wednesday') ? (0, _litElement.html)(_templateObject10()) : null, this.availableDays.includes('thursday') ? (0, _litElement.html)(_templateObject11()) : null, this.availableDays.includes('friday') ? (0, _litElement.html)(_templateObject12()) : null, this.availableDays.includes('saturday') ? (0, _litElement.html)(_templateObject13()) : null, this.availableDays.includes('sunday') ? (0, _litElement.html)(_templateObject14()) : null);
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js","../UserAPI":"UserAPI.js","../Toast":"Toast.js"}],"components/va-user2.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-user2', class User extends _litElement.LitElement {
  constructor() {
    super();
  }
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js","../UserAPI":"UserAPI.js","../Toast":"Toast.js"}],"components/va-user3.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n    <style>\n\n      .show-more-btn {\n        margin-top: 0.25em;\n        /* margin-left: 1.9em; */\n        z-index: 999;\n        opacity: 0.4;\n      }\n\n      .show-more-btn::part(label):hover {\n        color:var(--brand-color);\n        transition: 0.3s;\n      }\n\n      .show-less-btn {\n        margin-top: -1em;\n        display: block;\n        margin-left: auto;\n        margin-right: auto;\n      }\n\n      .show-less-btn::part(label):hover {\n        color:var(--brand-color);\n        transition: 0.3s;\n      }\n\n      .user-details {\n        padding: 1em;\n      }\n\n\n      .user-info-small sl-button::part(base) {\n        background: none;\n        border: none;\n        padding: 0;\n        margin: 0;\n        margin-top: -1em;\n      }\n\n      .user-info-small sl-button::part(label) {\n        color: #fff;\n        padding: 0;\n        font-weight: 200;\n      }\n\n      .test {\n        border: 2px solid red;\n      }\n\n      h1, h2, h3, h4, p {\n        color: #fff;\n      }\n\n      .profile-divider {\n        width: 100%;\n        height: 1px;\n        background-color: #8a8a8a;\n        margin-top: 2%;\n        margin-bottom: 2%;\n      }\n      \n      \n      .sports-container {\n        display: flex;\n        flex-wrap: wrap;\n        width: 100%;\n        min-height: 50px;\n        margin-top: -20px;\n      }\n      \n      .user-info h4 {\n        font-weight: 500;\n      }\n      \n      .profile-bio {\n        font-size: 0.8em;\n      }\n      \n      .profile-availability {\n        display: flex;\n        flex-wrap: wrap;\n        width: 100%;\n        height: 50px;\n        margin-top: -20px;\n      }\n      \n      .wk-day {\n        margin: auto;\n      }\n\n      .wk-day p {\n        color: #b3b3b3;\n      }\n      \n      .user-info-small {\n\n        width: 100%;\n        padding-top: 0em;\n        overflow: hidden;\n        z-index: 11;\n      }\n\n      .user-profile-small {\n        z-index: 10;\n        margin: 0;\n        border-radius: 30px;\n        display: flex;\n        width: 100%;\n        align-items: center;\n        justify-content: center;\n      }\n\n      h2 {\n        font-size: 1.2em;\n        margin-top: 2em;\n      }\n\n      .available {\n        font-weight: bold;\n        color: #0ab60f;\n      }\n\n      .sports-container p {\n        margin: auto;\n        box-shadow: inset 0 0 10px rgba(255, 255, 255, 0.3);\n        border-radius: 15px;\n        padding: 0.5em;\n        margin-top: 0.3em;\n      }\n\n      .profile-av-small {\n        background: #575c61;\n        border-radius: 50%;\n        --size: 100px; \n        margin-bottom: 1em; \n        box-shadow: 0px 5px 5px 0px #00000040;\n        float: left;\n        margin: 0.5em 0.5em 0.5em 0em;\n        padding: 0.5em;\n      }\n\n      .hide {\n        display: none;\n      }\n\n      .m-top {\n        margin-top: 0.2em;\n      }\n\n      .smessage::part(base) {\n        width: 100%;\n        height: fit-content;\n        background: none;\n        border: none;\n      }\n\n      .smessage {\n        width: 100%;\n        border: 2px solid red;\n        position: absolute;\n      }\n\n      .background {\n        background: rgb(255,255,255);\n        background: linear-gradient(90deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.12) 15%, rgba(255,255,255,0.12) 35%);\n        position: absolute;\n        width: 100%;\n        height: 80px;\n        margin-top: -50px;\n        z-index: 1;\n      }\n\n\n    </style>\n    \n    <div class=\"user-profile-small calign\"> \n        <div class=\"user-info-small\">\n          <sl-avatar @click=", " class=\"profile-av-small\" shape=\"circle\" image=\"", "/images/", "\"></sl-avatar>\n          <h2>", "</h2>\n          <div class=\"user-location\" style=\"display: flex; flex-wrap: wrap;\">\n            <img style=\"height: 15px; width: 15px;\" src=\"../../images/location.svg\" alt=\"\">\n            <p style=\"font-weight: 200; padding: 0; margin: 0 0 0 5px;\"> 0 kilometers away </p>\n            <div class=\"background\" @click=", "></div>\n        </div>\n\n          <br>\n\n          <div class=\"user-details hide\">\n\n            <h4> Sports </h4>\n            <div class=\"sports-container\">\n              <p class=\"tennis m-top\">", "</p>\n              <p class=\"boxing m-top\">", "</p>\n              <p class=\"basketball m-top\">", "</p>\n              <p class=\"tableTennis m-top\">", "</p>\n              <p class=\"martialArts m-top\">", "</p>\n              <p class=\"chess m-top\">", "</p>\n            </div>\n\n            <div class=\"profile-divider\"></div>\n              <p class=\"profile-bio\">", "</p>\n            <div class=\"profile-divider\"></div>\n\n            <h4> Available </h4>\n            <div class=\"profile-availability\">\n              <div class=\"wk-day monday\"> ", " <p>Mon</p></div>\n              <div class=\"wk-day tuesday\"> ", " <p>Tue</p></div>\n              <div class=\"wk-day wednesday\"> ", " <p>Wed</p></div>\n              <div class=\"wk-day thursday\"> ", " <p>Thu</p></div>\n              <div class=\"wk-day friday\"> ", " <p>Fri</p></div>\n              <div class=\"wk-day saturday\"> ", " <p>Sat</p></div>\n              <div class=\"wk-day sunday\"> ", " <p>Sun</p></div>\n            </div>\n          </div>\n\n          <sl-button class=\"show-more-btn\" @click=", ">Show Profile <sl-icon name=\"caret-down-fill\"></sl-icon></sl-button>\n          <sl-button class=\"show-less-btn hide\" @click=", ">Hide Profile <sl-icon name=\"caret-up-fill\"></sl-icon></sl-button>\n        </div>\n\n      </div> \n    </div>\n    \n  "]);
...
customElements.define('va-user3', class User extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  messageScreen() {
    ...
    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.avatar, this.firstName, this.removeView.bind(this));
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), this.messageScreen.bind(this), _App.default.apiBase, this.avatar, this.firstName, this.messageScreen.bind(this), this.sports.includes('tennis') ? 'Tennis' : (0, _litElement.html)(_templateObject3()), this.sports.includes('boxing') ? 'Boxing' : (0, _litElement.html)(_templateObject4()), this.sports.includes('basketball') ? 'Basketball' : (0, _litElement.html)(_templateObject5()), this.sports.includes('tableTennis') ? 'Table Tennis' : (0, _litElement.html)(_templateObject6()), this.sports.includes('martialArts') ? 'Martial Arts' : (0, _litElement.html)(_templateObject7()), this.sports.includes('chess') ? 'Chess' : (0, _litElement.html)(_templateObject8()), this.bio, this.availableDays.includes('monday') ? (0, _litElement.html)(_templateObject9()) : null, this.availableDays.includes('tuesday') ? (0, _litElement.html)(_templateObject10()) : null, this.availableDays.includes('wednesday') ? (0, _litElement.html)(_templateObject11()) : null, this.availableDays.includes('thursday') ? (0, _litElement.html)(_templateObject12()) : null, this.availableDays.includes('friday') ? (0, _litElement.html)(_templateObject13()) : null, this.availableDays.includes('saturday') ? (0, _litElement.html)(_templateObject14()) : null, this.availableDays.includes('sunday') ? (0, _litElement.html)(_templateObject15()) : null, this.moreInfoHandler.bind(this), this.moreInfoHandler.bind(this));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js","../UserAPI":"UserAPI.js","../Toast":"Toast.js"}],"components/va-user-av.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n    <style>\n      .user-avatar {\n        margin: 0.2em;\n        display: inline-block;\n        max-width: 130px;\n      }\n\n      .user-avatar p{\n        color: #fff;\n        font-weight: 400;\n        font-size: 1em;\n      }\n\n      .profile-av {\n        --size: 120px;\n        border-radius: 50%;\n        padding: 0.5em;\n        box-shadow: 0px 5px 5px 0px #00000025;\n      }\n\n      .av-button::part(base) {\n        background: none;\n        border: none;\n      }\n\n      .av-button {\n        height: 190px;\n      }\n\n      .av-button p{\n        margin: 0;\n        font-weight: 600;\n        font-size: 1.1em;\n      }\n\n    </style>\n\n    <div class=\"user-avatar\">\n      <sl-button class=\"av-button\" @click=", ">\n        <sl-avatar class=\"profile-av\" shape=\"circle\" image=\"", "/images/", "\"></sl-avatar>\n        <p>", "</p>\n      </sl-button>\n    </div>\n\n    \n  "]);
...
customElements.define('va-user-av', class User extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), this.messageScreen.bind(this), _App.default.apiBase, this.avatar, this.firstName);
  }
...
},{"./..\\..\\static\\images\\facebook.svg":[["facebook.a30b88f8.svg","../static/images/facebook.svg"],"../static/images/facebook.svg"],"./..\\..\\static\\images\\google.svg":[["google.84295cde.svg","../static/images/google.svg"],"../static/images/google.svg"],"./..\\..\\static\\images\\instagram.svg":[["instagram.7b096def.svg","../static/images/instagram.svg"],"../static/images/instagram.svg"],"./..\\..\\static\\images\\nav-fade.svg":[["nav-fade.b26cff1a.svg","../static/images/nav-fade.svg"],"../static/images/nav-fade.svg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
require("./components/va-user2");

require("./components/va-user3");

require("./components/va-user-av");
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-user":"components/va-user.js","./components/va-user2":"components/va-user2.js","./components/va-user3":"components/va-user3.js","./components/va-user-av":"components/va-user-av.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
